...
dotnet restore "$DEPLOYMENT_SOURCE/Solution/Personal.Portfolio.csproj"
exitWithMessageOnError "dotnet restore failed"

# 2. Build and publish
dotnet publish "$DEPLOYMENT_SOURCE/Solution/Personal.Portfolio.csproj" --output "$DEPLOYMENT_TEMP" --configuration Release
